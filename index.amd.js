define(['hyprlivecontext','modules/jquery-mozu','underscore','backbone','modules/api'],function(hyprContext,$,_,Backbone,api){'use strict';hyprContext=hyprContext&&hyprContext.hasOwnProperty('default')?hyprContext['default']:hyprContext;$=$&&$.hasOwnProperty('default')?$['default']:$;_=_&&_.hasOwnProperty('default')?_['default']:_;Backbone=Backbone&&Backbone.hasOwnProperty('default')?Backbone['default']:Backbone;api=api&&api.hasOwnProperty('default')?api['default']:api;var hasOwnProperty = {}.hasOwnProperty;
...
};var hiddenKeys = {};var arrayIndexOf = arrayIncludes(false);
...
} : nativeAssign;// https://github.com/zloirock/core-js/issues/86#issuecomment-115759028
var global = typeof window == 'object' && window && window.Math == Math ? window
  : typeof self == 'object' && self && self.Math == Math ? self
  // eslint-disable-next-line no-new-func
  : Function('return this')();// Thank's IE8 for his funny defineProperty
...
});var functionToString = shared('native-function-to-string', Function.toString);var WeakMap = global.WeakMap;
...
_export({ target: 'Object', stat: true, forced: Object.assign !== objectAssign }, { assign: objectAssign });var locals = hyprContext.locals || {};
var context = locals;// `IsArray` abstract operation
...
} : test.toString;var ObjectPrototype = Object.prototype;
...
var whitespaces = '\x09\x0A\x0B\x0C\x0D\x20\xA0\u1680\u2000\u2001\u2002\u2003\u2004\u2005\u2006\u2007\u2008\u2009\u200A\u202F\u205F\u3000\u2028\u2029\uFEFF';var whitespace = '[' + whitespaces + ']';
...
};var iterators = {};// check on default Array iterator
...
var html = document$2 && document$2.documentElement;var set$1 = global.setImmediate;
...
var userAgent = navigator && navigator.userAgent || '';var getOwnPropertyDescriptor$1 = objectGetOwnPropertyDescriptor.f;
...
};var path = global;var aFunction$1 = function (variable) {
...
var _curryN = function _curryN(len, fn) {
  return function () {
    var _curryN2;
...
var curry = function curry(fn) {
  return function () {
    return arguments.length === fn.length ? fn.apply(void 0, arguments) : _curryN(fn.length, fn).apply(void 0, arguments);
  };
};

var curryN = curry(_curryN);
var lens = curry(function (path, obj) {
...
var type = ["Object", "Null", "Undefined", "Array", "Number", "String", "Function", "Boolean"].reduce(function (a, t) {
...
var storage = function storage(source) {
  var store = {
...
var globalEventBus = Backbone.events;
var common = {
  ...
  context: context
}, common);var correctPrototypeGetter = !fails(function () {
  function F() { /* empty */ }
...
hiddenKeys[IE_PROTO$1] = true;var IteratorPrototype$1 = iteratorsCore.IteratorPrototype;
...
}() : undefined);var ITERATOR$4 = wellKnownSymbol('iterator');
...
});var promise$1 = path.Promise;var $AggregateError = function AggregateError(errors, message) {
  var that = this;
...
};var startsWith = entryUnbind('String', 'startsWith');var ENDS_WITH = 'endsWith';
...
});var endsWith = entryUnbind('String', 'endsWith');var INCLUDES = 'includes';
...
});var includes = entryUnbind('String', 'includes');var assign = path.Object.assign;var internalFind = arrayMethods(5);
var FIND = 'find';
...
// https://tc39.github.io/ecma262/#sec-array.prototype-@@unscopables
addToUnscopables(FIND);var find = entryUnbind('Array', 'find');var index = {
  utilities: utilities
};return index;});